        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form id="myForm" action="<?php echo e(route('admin.privacy-policy-page-update')); ?>" method="post"
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-3">
                            <h6 class="mb-0">Privecy Policy</h6>
                        </div>
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\XAMPP\htdocs\President\resources\views/backend/privacy_policy_page.blade.php ENDPATH**/ ?>