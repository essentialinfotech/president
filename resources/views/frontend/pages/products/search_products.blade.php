                        ...
                        <div class="filter-section border_b">
                            ...
                            <ul class="scrollable collapse multi-collapse show" id="multiCollapseExample1">
                                @foreach ($products as $category)
                                    <li
                                        style="background:{{ request()->is('category/' . $category->product_category->slug) ? '#CCCCCC' : '' }}">
                                        <a class="d-block"
                                            href="{{ route('category.products', $category->product_category->slug) }}"
                                            style="font-size: 14px;">{{ $category->product_category->name }}</a>
                                    </li>
                                @endforeach
                            </ul>
