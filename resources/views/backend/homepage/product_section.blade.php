    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <hr />
                <form id="myForm" action="{{ route('admin.product-section-update') }}" method="post"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class=" form-group col-sm-9 text-secondary">
                            <textarea class="form-control" name="product_description" id="">{{ $product->product_description }}</textarea>
                        </div>
                    </div>
