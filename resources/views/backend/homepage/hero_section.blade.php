    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <hr />
                <form id="myForm" action="{{ route('admin.hero-section-update') }}" method="post"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <img id="hero_banner_img" src="{{ asset($hero->hero_banner_img) }}" alt="hero_banner_img"
                                style="width: 100px;">
                        </div>
                    </div>
                    {{-- End Banner Image --}}
                    <div class="row mb-3">
                        ...
                        <div class=" form-group col-sm-9 text-secondary">
                            <input type="text" name="hero_banner_alt" value="{{ $hero->hero_banner_alt }}"
                            class="form-control" />
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class=" form-group col-sm-9 text-secondary">
                            <input type="text" name="hero_title" class="form-control" value="{{ $hero->hero_title }}" />
                        </div>
                    </div>
                    {{-- <div class="row mb-3">
                        <div class="col-sm-3">
                            <h6 class="mb-0">Title Animate</h6>
                        </div>
                        <div class=" form-group col-sm-9 text-secondary">
                            <input type="text" name="hero_title_animate" class="form-control"
                                value="{{ $hero->hero_title_animate }}" />
                        </div>
                    </div> --}}
                    <div class="row mb-3">
                        <div class="col-sm-3">
                        ...
                        <div class=" form-group col-sm-9 text-secondary">
                            <textarea class="form-control" name="hero_description" id="">{{ $hero->hero_description }}</textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-3">
