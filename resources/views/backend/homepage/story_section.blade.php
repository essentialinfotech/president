    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <hr />
                <form id="myForm" action="{{ route('admin.story-section-update') }}" method="post"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                            <img id="story_banner_img" src="{{ asset($story->story_banner_img) }}" alt="story_banner_img"
                                style="width: 100px;">
                        </div>
                    </div>
                    {{-- End Banner Image --}}
                    ...
                    <div class="row mb-3">
                        ...
                        <div class=" form-group col-sm-9 text-secondary">
                            <input type="text" name="story_subtitle"
                                class="form-control @error('story_subtitle') is-invalid @enderror"
                                value="{{ $story->story_subtitle }}" />
